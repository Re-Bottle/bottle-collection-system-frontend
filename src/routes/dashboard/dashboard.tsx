...
export default function Dashboard() {
  ...
  return (
    <div className="d-flex">
      ...
      <div
        className="bg-success text-white shadow-lg rounded-end p-3 position-fixed d-flex flex-column"
        style={{ width: "250px", minHeight: "100vh", top: 0, left: 0 }}
      >
        <h3 className="text-center mb-4">Hi {user?.name.split(" ")[0]}!</h3>
      ...
      <div
        ...
        style={{ paddingLeft: "250px", paddingTop: "20px" }}
      >
